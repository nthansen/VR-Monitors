...
#define DEX_SETDESKTOPWALLPAPER		(WM_HOOXPOTRUFT + 243)
#define DEX_SETDESKTOPWALLPAPER2	(WM_HOOXPOTRUFT + 244)
#define DEX_SETDESKTOPCOUNT			(WM_HOOXPOTRUFT + 245)
...
#define DEX_SWITCH_NOBACKGROUNDCHANGE	0x0008
